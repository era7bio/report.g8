...
\DeclareFieldFormat{doi}{\newline DOI:  \ttfamily\small\href{https://dx.doi.org/#1}{#1}}
\DeclareFieldFormat{url}{}
\DeclareFieldFormat[unpublished,misc,article]{url}{\newline URL: \ttfamily\small\href{#1}{#1}}
\DeclareFieldFormat
...
% Open Sans as main font
\setmainfont[
  Mapping = tex-text,
  Color = Grey,
  BoldFont = {* Semibold}, BoldItalicFont = {* Semibold Italic}, ItalicFont = {* Italic}
]{Open Sans}

% Bitter for section titles
...
% Open Sans Light for the title
\newfontfamily\titlefont[
  Mapping = tex-text,
  BoldFont={Open Sans}
]{Open Sans Light}

% Asana Math, similar to Cambria Math; somehow matches a sans body text
...
% TODO there's probably something conflicting here
...
\renewcommand{\includegraphics}[1]{\Oldincludegraphics[width=\maxwidth, height=.8\textheight, keepaspectratio]{#1}}
