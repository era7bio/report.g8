...
\lfoot{\titlefont {\color{Grey-Light} 
© \href{http://era7bioinformatics.com}{era7 bioinformatics}
}}
\cfoot{\titlefont\footnotesize {\color{Grey-Light}
Era7 Bioinformatics SLU \\
Ins. Reg. Mer. de Granada Tomo 1110, \\
Libro 0, Folio 77 Hoja 8 GR 25007 \\ 
NIF: B18697110 \\
}}
\rfoot{\titlefont {\color{Grey-Light}
...
\includegraphics[scale=.21]{/home/eparejatobes/.pandoc/templates/logo-era7.pdf}
  ...
  \begin{minipage}{.86\textwidth}\center\titlefont
    ...
    \begin{minipage}{.50\textwidth}\center
  \vspace{2\baselineskip}
    {\Large\titlefont
      Project: {\bfseries meta\_mbo}
    }
